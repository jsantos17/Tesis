...
#
# Created: Thu Mar  7 15:21:53 2013
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.resize(719, 335)
        self.centralwidget = QtGui.QWidget(mainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.horizontalLayoutWidget = QtGui.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 80, 691, 231))
        ...
        self.smu1_label = QtGui.QLabel(self.horizontalLayoutWidget)
        ...
        self.smu1_combo = QtGui.QComboBox(self.horizontalLayoutWidget)
        self.smu1_combo.setObjectName(_fromUtf8("smu1_combo"))
        self.verticalLayout.addWidget(self.smu1_combo)
        self.smu1_groupbox = QtGui.QGroupBox(self.horizontalLayoutWidget)
        ...
        self.smu2_label = QtGui.QLabel(self.horizontalLayoutWidget)
        ...
        self.smu2_combo = QtGui.QComboBox(self.horizontalLayoutWidget)
        self.smu2_combo.setObjectName(_fromUtf8("smu2_combo"))
        self.verticalLayout_2.addWidget(self.smu2_combo)
        self.smu2_groupbox = QtGui.QGroupBox(self.horizontalLayoutWidget)
        ...
        self.smu3_label = QtGui.QLabel(self.horizontalLayoutWidget)
        ...
        self.smu3_combo = QtGui.QComboBox(self.horizontalLayoutWidget)
        self.smu3_combo.setObjectName(_fromUtf8("smu3_combo"))
        self.verticalLayout_3.addWidget(self.smu3_combo)
        self.smu3_groupbox = QtGui.QGroupBox(self.horizontalLayoutWidget)
        ...
        self.smu4_label = QtGui.QLabel(self.horizontalLayoutWidget)
        ...
        self.smu4_combo = QtGui.QComboBox(self.horizontalLayoutWidget)
        self.smu4_combo.setObjectName(_fromUtf8("smu4_combo"))
        self.verticalLayout_4.addWidget(self.smu4_combo)
        self.smu3_groupbox_2 = QtGui.QGroupBox(self.horizontalLayoutWidget)
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(15, 9, 681, 64))
        self.verticalLayoutWidget_5.setObjectName(_fromUtf8("verticalLayoutWidget_5"))
        self.ip_file_layout = QtGui.QVBoxLayout(self.verticalLayoutWidget_5)
        self.ip_file_layout.setMargin(0)
        self.ip_file_layout.setObjectName(_fromUtf8("ip_file_layout"))
        self.horizontalLayout = QtGui.QHBoxLayout()
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.ipLabel = QtGui.QLabel(self.verticalLayoutWidget_5)
        ...
        self.ipField = QtGui.QLineEdit(self.verticalLayoutWidget_5)
        ...
        self.connect_button = QtGui.QPushButton(self.verticalLayoutWidget_5)
