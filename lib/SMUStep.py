...
class SMUStep(SMUBase):
    ...
    def __init__(self, voltage_name, current_name, source_mode, ch_number, source_type, start, steps, compliance):
        super(SMUBase, self).__init__(voltage_name, current_name, source_mode, ch_number)
